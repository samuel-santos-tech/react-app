                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Faça o login</h3>
                            <p className="">Já tem uma conta? <Link to={'/Login'} className="font-medium text-indigo-600 hover:text-indigo-500">Faça Login</Link></p>
                        </div>
                    </div>

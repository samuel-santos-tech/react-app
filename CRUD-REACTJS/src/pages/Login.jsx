        ...
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="https://logodownload.org/wp-content/uploads/2016/10/olx-logo-0.png" width={150} />
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Crie anuncios e venda seu produto rapidamente</h3>
                        <p className="text-gray-300">
                            Crie uma conta com 30 dias gratis
                        </p>
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Faça seu cadastro</h3>
                            <p className="">Já tem uma conta? <Link to={"/Cadastro"} className="font-medium text-indigo-600 hover:text-indigo-500">Cadastre-se</Link></p>
                        </div>
                    </div>
                    <div className="grid grid-cols-3 gap-x-3">
                        ...
                        <button type="submit" className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
